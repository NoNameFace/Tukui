...
bar:SetScript("OnEvent", function(self, event, ...)
	if event == "PLAYER_LOGIN" then
		...
		for i = 1, NUM_SHAPESHIFT_SLOTS do
			...
			if i == 1 then
				button:SetPoint("TOPRIGHT", TukuiMinimap, TukuiDB.Scale(29), TukuiDB.Scale(21)) -- move shiftbar left/right or up/down
			else
				local previous = _G["ShapeshiftButton"..i-1]
				button:SetPoint("TOP", previous, "BOTTOM", 0, -TukuiDB.Scale(4)) -- make vertical and grow down
			end
