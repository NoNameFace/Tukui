...
Minimap:SetPoint("TOPLEFT", UIParent, "TOPLEFT", TukuiDB.Scale(14), TukuiDB.Scale(-36))
...
-- new guild dungeon thing (I'm in ur fielz leavin commentz)
GuildInstanceDifficulty:ClearAllPoints()
GuildInstanceDifficulty:SetParent(Minimap)
GuildInstanceDifficulty:SetPoint("TOPRIGHT", Minimap, "TOPRIGHT", TukuiDB.Scale(-2), TukuiDB.Scale(-2))
